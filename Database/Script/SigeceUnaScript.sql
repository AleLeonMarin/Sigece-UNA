...
CREATE TABLE
    sis_gestion (
        ...
        ges_estado VARCHAR2 (1) DEFAULT 'P' NOT NULL CONSTRAINT sis_gestion_ck01 CHECK (ges_estado in ('S', 'P')),
        ges_solicitante_id NUMBER NOT NULL,
        ges_asignado_id NUMBER NOT NULL,
        ges_sub_id NUMBER NOT NULL,
...
CREATE TABLE
    sis_aprobaciones (
        ...
        apro_estado VARCHAR2 (1) DEFAULT 'P' NOT NULL CONSTRAINT sis_aprobaciones_ck01 CHECK (apro_estado in ('A', 'P')),
