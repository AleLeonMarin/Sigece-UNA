...
public class MailsController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Correos encontrados"),
            @ApiResponse(responseCode = "400", description = "Error al obtener los correos")
    })
    public Response getMails() {
        try {
            ...
            LOG.severe("Ocurrió un error al obtener los correos.");
            return Response.status(CodigoRespuesta.ERROR_INTERNO.getValue())
                    .entity("Ocurrió un error al obtener los correos.")
                    .build();
        }
    }
